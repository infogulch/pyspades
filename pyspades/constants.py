...
GAME_VERSION = 3
PT_VERSION = 3
(RIFLE_WEAPON, SMG_WEAPON, SHOTGUN_WEAPON, RIFLE_PT_WEAPON, SMG_PT_WEAPON, SHOTGUN_PT_WEAPON) = xrange(6)
ASP_TERM, ASP_INT, ASP_FLOAT, ASP_PSTRING = xrange(4)
